...
<body>
    ...
    <% String professorNome=(String) session.getAttribute("professorNome"); String codigoVendedor=(String)
        session.getAttribute("codigoVendedor"); %>
        ...
        <header>
            ...
            <div class=" login">
                <a href="gerenciar.jsp?codigoVendedor=<%= session.getAttribute(" codigoVendedor") %>">Gerenciar
                    Cursos</a>
            </div>
        ...
        <section id="courses" class="cursos">
            ...
            <div class="listaCursos">
                ...
                <div class="curso1">
                    ...
                    <p>Domine ferramentas e tecnicas de design.</p>
                    <button>Saiba Mais</button>
                </div>
                <div class="curso1">
